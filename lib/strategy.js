    ...
    function loaded(err, ok, state) {
      ...
      self._oauth2.getOAuthAccessToken(code, params,
        function(err, accessToken, refreshToken, params) {
          ...
          }, req.session.connectAccountForUser);
        }
      );
    }
 ...
 * @api private
 */
OAuth2Strategy.prototype._loadUserProfile = function(accessToken, done, connectAccountForUser) {
  var self = this;

  function loadIt() {
    return self.userProfile(accessToken, done, connectAccountForUser);
  }
  function skipIt() {
    return done(null);
  }
