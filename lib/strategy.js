    ...
    function loaded(err, ok, state) {
      ...
      self._oauth2.getOAuthAccessToken(code, params,
        function(err, accessToken, refreshToken, params) {
          ...
          }, req.session.connectAccountForUser, req.session.passport && req.session.passport.user);
        }
      );
    }
 ...
 * @api private
 */
OAuth2Strategy.prototype._loadUserProfile = function(accessToken, done, connectAccountForUser, lrUserId) {
  var self = this;

  function loadIt() {
    return self.userProfile(accessToken, done, connectAccountForUser, lrUserId);
  }
  function skipIt() {
    return done(null);
  }
